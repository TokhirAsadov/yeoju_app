...
public class TestV2Updater {
    ...
    public TestV2Updater(String title, Integer singleChoiceCount, Integer singleChoiceBall, Integer multipleChoiceCount, Integer multipleChoiceBall, Integer writtenCount, Integer writtenBall, Integer passingBall, String moduleId) {
        this.title = title;
