...
public interface GetDate31 {
    ...
    @Value("#{@teacherRepository.getEnterOutTimesNEW(target.id,target.date,'/30')}")
    GetEnterOutTimes get30();

    @Value("#{@teacherRepository.getEnterOutTimesNEW(target.id,target.date,'/31')}")
    GetEnterOutTimes get31();
