...
public interface VedimostService {
    ...
    ApiResponse getDataAboutVedimostByDekanat(String dekanatId, String educationYearId);

    ApiResponse getDataAboutVedimostByKafedra(String kafedraId, String educationYearId);
}
