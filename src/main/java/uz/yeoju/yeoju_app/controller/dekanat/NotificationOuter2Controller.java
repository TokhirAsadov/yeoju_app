...
import uz.yeoju.yeoju_app.service.serviceInterfaces.implService.notificationOuter2.NotificationOuter2Service;

@RestController
@RequestMapping(BaseUrl.BASE_URL+"/operation")
@RequiredArgsConstructor
public class NotificationOuter2Controller {
    private final NotificationOuter2Service service;
