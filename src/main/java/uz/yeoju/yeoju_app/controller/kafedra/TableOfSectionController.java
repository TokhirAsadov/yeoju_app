...
import uz.yeoju.yeoju_app.service.serviceInterfaces.implService.kafedra.table.SectionTableService;

import java.io.IOException;

@RestController
@RequestMapping(BaseUrl.BASE_URL+"/section-table")
@RequiredArgsConstructor
public class TableOfSectionController {
    private final SectionTableService service;
