...
public interface VedimostRepository extends JpaRepository<Vedimost, String> {
    ...
    Set<GetVedimostOfKafedra> getVedimostByTeacherIdAndLessonId(String teacherId,String educationYearId,String lessonId);
    ...
    Set<GetVedimostOfKafedra> getVedimostByTeacherIdAndFacultyId(String teacherId,String facultyId,String educationYearId);
