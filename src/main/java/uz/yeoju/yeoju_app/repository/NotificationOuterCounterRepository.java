...
public interface NotificationOuterCounterRepository extends JpaRepository<NotificationOuterCounter,String> {
    ...
    @Query(value = "select u.id as studentId, u.fullName,g.name as groupName,g.level,f.name as direction, NOC.id,ey.name as educationYear, n.fromDate,n.toDate,n.createdAt,n.queue,n.dynamicSection,NOC.queue as studentQueue from NotificationOuter n\n" +
