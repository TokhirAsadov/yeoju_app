...
import uz.yeoju.yeoju_app.entity.moduleV2.DownloadCounterV2;
...
public interface DownloadCounterV2Repository extends JpaRepository<DownloadCounterV2,String> {

    Boolean existsDownloadCounterV2ByUserIdAndTopicId(String user_id, String topic_id);
    Optional<DownloadCounterV2> findDownloadCounterV2ByUserIdAndTopicId(String user_id, String topic_id);
